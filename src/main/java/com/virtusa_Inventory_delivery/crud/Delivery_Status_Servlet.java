...
/**
 * Servlet implementation class Delivery_Status_Servlet
 */
public class Delivery_Status_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Delivery_Status_Servlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(ddDao.addDeliveryStatus(dd)) {
				response.sendRedirect("today_delivery.jsp");
			}
			else {
